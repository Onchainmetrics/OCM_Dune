...
token_meta AS (
    ...
    WHERE token_address != 'So11111111111111111111111111111111111111112' AND token_address != 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'
),
...
alpha_trades AS (
    ...
    AND t.token_bought_mint_address != 'So11111111111111111111111111111111111111112' AND t.token_bought_mint_address != 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'
    ...
    WHERE t.block_time >= (SELECT hour_24 FROM time_windows)
    AND t.token_sold_mint_address != 'So11111111111111111111111111111111111111112' AND t.token_sold_mint_address != 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'
),
